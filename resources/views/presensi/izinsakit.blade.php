                            ...
                            <div class="col-3">
                                <div class="input-icon mb-3">
                                    ...
                                    <input type="text" value="{{ Request('nama_lengkap') }}" id="nama_lengkap"
                                        class="form-control" placeholder="Nama Guru" name="nama_lengkap">
                                </div>
                            </div>
                                    ...
                                    <div class="form-group">
                                        <select name="kode_sekolah" id="kode_sekolah" class="form-select">
                                            ...
                                            @foreach ($sekolah as $d)
                                                <option {{ Request('kode_sekolah') == $d->kode_sekolah ? 'selected' : '' }}
                                                    value="{{ $d->kode_sekolah }}">
                                                    {{ strtoupper($d->nama_sekolah) }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                        ...
                                        <select name="kode_jurusan" id="kode_jurusan" class="form-select">
                                            ...
                                            @foreach ($jurusan as $d)
                                                <option {{ Request('kode_jurusan') == $d->kode_jurusan ? 'selected' : '' }}
                                                    value="{{ $d->kode_jurusan }}">
                                                    {{ strtoupper($d->nama_jurusan) }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
