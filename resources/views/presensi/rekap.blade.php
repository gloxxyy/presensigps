                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="/presensi/cetakrekap" target="_blank" method="POST">
                                            ...
                                            <div class="form-group">
                                                <select name="kode_sekolah" id="kode_sekolah" class="form-select">
                                                    ...
                                                    @foreach ($sekolah as $d)
                                                        <option value="{{ $d->kode_sekolah }}">{{ strtoupper($d->nama_sekolah) }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                ...
                                @else
                                    <input type="hidden" name="kode_sekolah"
                                        value="{{ Auth::guard('user')->user()->kode_sekolah }}">
                                @endrole
                                <div class="row mt-2">
                                    <div class="col-12">
                                        <div class="form-group">
                                ...
                                @else
                                    <input type="hidden" name="kode_jurusan"
                                        value="{{ Auth::guard('user')->user()->kode_jurusan }}">
                                @endrole
                                <div class="row mt-2">
                                    <div class="col-12">
                                        <div class="form-group">
