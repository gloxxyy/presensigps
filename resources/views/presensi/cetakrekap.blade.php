    ...
    <section class="sheet padding-10mm">
        ...
        <table style="width: 100%">
            <tr>
                ...
                <td>
                    <span id="title">
                        REKAP PRESENSI GURU<br>
                        PERIODE {{ strtoupper($namabulan[$bulan]) }} {{ $tahun }}<br>
                        SMK NEGERI 3 PARIAMAN<br>
                    </span>
                    <span><i>Pariaman, Sumatera Barat</i></span>
                </td>
            </tr>
        </table>
        ...
        <table width="100%" style="margin-top:100px">
            <tr>
                <td></td>
                <td style="text-align: center">Pariaman, {{ date('d-m-Y') }}</td>
            </tr>
            <tr>
