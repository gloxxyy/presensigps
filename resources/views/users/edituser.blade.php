            ...
            <div class="form-group">
                <select name="kode_jurusan" id="kode_jurusan" class="form-select">
                    ...
                    @foreach ($jurusan as $d)
                        <option {{ $user->kode_jurusan == $d->kode_jurusan ? 'selected' : '' }} value="{{ $d->kode_jurusan }}">
                            {{ $d->nama_jurusan }}</option>
                    @endforeach
                </select>
            </div>
        </div>
            ...
            <div class="form-group">
                <select name="kode_sekolah" id="kode_sekolah" class="form-select">
                    ...
                    @foreach ($sekolah as $d)
                        <option {{ $user->kode_sekolah == $d->kode_sekolah ? 'selected' : '' }}
                            value="{{ $d->kode_sekolah }}">{{ strtoupper($d->nama_sekolah) }}
                        </option>
                    @endforeach
                </select>
            </div>
